  ...
  collector.on("end", async () => {
    ...
    if (topOptions.length > 1) {
      ...
      best = winner;
	      ...
	      // Keep the result in a normal channel message too. The spinner is
	      // intentionally edited during the animation, so its final state is
	      // not a reliable sole record of the winning choice.
