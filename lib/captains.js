...
async function runCaptainDraft(message, players, { reminderMs = 60000 } = {}) {
  ...
  const firstTeam = await runBlindRps(message, declaredCaptains, { reminderMs });
...
async function runBlindRps(message, captains, { reminderMs }) {
